...
f(:,:,1) = (RImage-GImage)*Ggain + 0.5; %rojo menos verda
f(:,:,2) = (GImage-Gmedian)*Ggain + 0.5; 
f(:,:,3) = (BImage-RImage)*Ggain + 0.5; %azul menos rojo
...
%sacamos perimetros,areas,greylevel,etc
...
%Sacamos la textura a diferentes distancias
    %%%%%%%%%%%%%%%% Temperature GLCM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
